...
public class ApplicationLeadingServiceImpl implements ApplicationLeadingService {
    ...
    public R submitLeadingApply(String userId, LeadingApplySubmitDTO form) {
        try {
            ...
            // 设置意向小区，空值设为 null
            leadingApply.setCommunityId1(form.getCommunityId1() != null && !form.getCommunityId1().isEmpty() ? form.getCommunityId1() : null);
            leadingApply.setCommunityId2(form.getCommunityId2() != null && !form.getCommunityId2().isEmpty() ? form.getCommunityId2() : null);
            leadingApply.setCommunityId3(form.getCommunityId3() != null && !form.getCommunityId3().isEmpty() ? form.getCommunityId3() : null);
            
            // 设置意向房型，空值设为 null
            leadingApply.setHouseType1(form.getHouseType1() != null ? form.getHouseType1() : null);
            leadingApply.setHouseType2(form.getHouseType2() != null ? form.getHouseType2() : null);
            leadingApply.setHouseType3(form.getHouseType3() != null ? form.getHouseType3() : null);
            leadingApply.setHouseType4(form.getHouseType4() != null ? form.getHouseType4() : null);
            ...
            leadingApply.setApplicantCompanyId(applicant.getCompanyId() != null && !applicant.getCompanyId().isEmpty() ? applicant.getCompanyId() : null);
            leadingApply.setApplicantCompanyUscc(getCompanyUscc(applicant.getCompanyId()));
            leadingApply.setExistLaborContract(form.getExistLaborContract() != null ? form.getExistLaborContract() : null); // 使用传入的劳动合同关系参数
    ...
    public R updateLeadingApply(String userId, LeadingApplyUpdateDTO form) {
        try {
            ...
            UpdateWrapper<ApplicationLeadingTalent> updateWrapper = new UpdateWrapper<>();
            ...
            // 执行更新
            applicationLeadingTalentMapper.update(null, updateWrapper);
